...
\begin{figure}[h]
	\centering
<<<<<<< Updated upstream:pt_characterization/real_data/paper.tex
	\subfigure[PT frequency on SORT144 on {\tt sodb8}]{
=======
	...
	\subfigure[PT frequency on INC17.2]{
		\includegraphics[scale=0.43]{inc17.2_dist.eps}
		\label{fig:inc17_2_dist}
	}
	\subfigure[PT frequency on SORT244]{
>>>>>>> Stashed changes:pt_characterization/real_data/paper_old.tex
...
=======
	...
	\subfigure[PT frequency on INC35.0]{
		\includegraphics[scale=0.43]{inc35.0_dist.eps}
		\label{fig:inc35_0_dist}
	}
