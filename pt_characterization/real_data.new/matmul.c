...
*/
	...
	MAT_SZ = task_length;
	int i=0,j=0;
	matrixA = (int**)malloc(sizeof(int*)*MAT_SZ);
	matrixB = (int**)malloc(sizeof(int*)*MAT_SZ);
	matrixC = (int**)malloc(sizeof(int*)*MAT_SZ);
	for(i=0;i<MAT_SZ;i++){
		matrixA[i] = (int*)malloc(sizeof(int)*MAT_SZ);
		matrixB[i] = (int*)malloc(sizeof(int)*MAT_SZ);
		matrixC[i] = (int*)malloc(sizeof(int)*MAT_SZ);
		for(j=0;j<MAT_SZ;j++){
