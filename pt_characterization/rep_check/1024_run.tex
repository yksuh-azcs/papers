...
\begin{figure}[hp!]
	\centering
	\subfigure[ET frequency on INC1024-Run1 on {\tt sodb9}]{
		\includegraphics[scale=0.28]{1024_run/1024_sec_et_hist1.eps}
		\label{fig:inc1024_run1_et}
	}
	\subfigure[ET frequency on INC1024-Run2 on {\tt sodb9}]{
		\includegraphics[scale=0.28]{1024_run/1024_sec_et_hist2.eps}
		\label{fig:inc1024_run2_et}
	}
	\subfigure[ET frequency on INC1024-Run3 on {\tt sodb9}]{
...
\begin{figure}[hp!]
	\centering
	\subfigure[PT frequency on INC1024-Run1 on {\tt sodb9}]{
		\includegraphics[scale=0.28]{1024_run/1024_sec_pt_hist1.eps}
		\label{fig:inc1024_run1_pt}
	}
	\subfigure[PT frequency on INC1024-Run2 on {\tt sodb9}]{
		\includegraphics[scale=0.28]{1024_run/1024_sec_pt_hist2.eps}
		\label{fig:inc1024_run2_pt}
	}
	\subfigure[PT frequency on INC1024-Run3 on {\tt sodb9}]{
		\includegraphics[scale=0.28]{1024_run/1024_sec_pt_hist3.eps}
