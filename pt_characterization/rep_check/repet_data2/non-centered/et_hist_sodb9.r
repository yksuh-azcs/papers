...
ymax <- ceiling(ymax/100)*100
ymax <- 400
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-3,xmax+6),col="blue", main='ET frequency on INC16', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
...
ymax <- max(h$counts)
ymax <- 80
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-5,xmax+19),col="blue", main='ET frequency on INC256', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
...
ymax <- max(h$counts)
ymax <- 50
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-9,xmax+16),col="blue", main='ET frequency on INC512', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
...
ymax <- max(h$counts)
ymax <- 60
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-10,xmax+20),col="blue", main='ET frequency on INC1024', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
