...
h = hist(x$METIME, right=F, breaks=seq(xmin,xmax+1,1),plot=F)
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC1', 
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC2', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC4', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC8', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC16', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC32', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC64', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- ceiling(ymax/100)*100
ymax <- 80
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC128', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
...
ymax <- ceiling(ymax/100)*100
ymax <- 80
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC256', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("256_sec_et_hist2.eps")
binsize=2
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- ceiling(ymax/100)*100
ymax <- 80
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC2048', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
#axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
...
ymax <- ceiling(ymax/100)*100
ymax <- 50
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC4096', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC3', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 250
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC6', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 250
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC12', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 300
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC24', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 150
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC48', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 200
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC72', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 200
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC80', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- 150
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC88', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
ymax <- max(h$counts)
ymax <- ceiling(ymax/100)*100
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC96', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("104_sec_et_hist.eps")
binsize=1
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
x <- subset(x, x$ITERNUM != 639)
xmin <-min(x$METIME)
...
ymax <- max(h$counts)
ymax <- 120
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC104', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("112_sec_et_hist.eps")
binsize=1
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- max(h$counts)
ymax <- 200
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC112', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("120_sec_et_hist1.eps")
binsize=1
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- max(h$counts)
ymax <- 150
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC120', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=h$mids,labels=seq(xmin,xmax,1))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("120_sec_et_hist.eps")
binsize=2
x <- subset(x, x$ITERNUM != 80 & x$ITERNUM != 797)
xmin <-min(x$METIME)
xmax <-max(x$METIME)
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("160_sec_et_hist.eps")
binsize=2
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- ceiling(ymax/100)*100
ymax <- 250
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC160', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("192_sec_et_hist.eps")
binsize=2
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- ceiling(ymax/100)*100
ymax <- 250
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC192', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
dev.off()
...
x <- subset(x, x$ITERNUM <= numSamples)
setEPS()
postscript("224_sec_et_hist.eps")
binsize=2
#x = subset(x, x$METIME >= x_dn & x$METIME <= x_up)
...
ymax <- ceiling(ymax/100)*100
ymax <- 200
plot(h, xaxt='n', axes = TRUE,freq=TRUE,ylim=c(0,ymax), col="blue",  main='ET frequency on INC224', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
axis(side=1,at=seq(min(h$mids),max(h$mids)+binsize,binsize),labels=seq(ceiling(min(h$mids)),ceiling(max(h$mids))+binsize,binsize))
dev.off()
