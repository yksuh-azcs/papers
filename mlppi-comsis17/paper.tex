...
\centering
\subfigure[1TB]{
	\includegraphics[scale=0.58]{1T_total_time}
	\label{fig:1T_eval_res}
}
\subfigure[3TB]{
	\includegraphics[scale=0.58]{3T_total_time}
...
\centering
\subfigure[1TB]{
	\includegraphics[scale=0.58]{1T_quality}
	\label{fig:1T_quality}
}
\subfigure[3TB]{
	\includegraphics[scale=0.58]{3T_quality}
...
%We believe our algorithm can be applied to any clustering and partitioning algorithm.
