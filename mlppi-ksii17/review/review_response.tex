...
We have incorporated into the revision our response to each of them. 
...
Yes, we include in our submission this letter that appears on the front page of the revised article. 
...
Today ({\bf\underline{October 14th, 2017 in KST}}), prior to the specified deadline of October 15, 2017, 
we're submitting this revision for further review. So no violation on the deadline.
...
A great suggestion. We have moved the Related Work section (now Section~2) upfront (on page 5), right after Section 1. Please also note that Section~2 is expanded with some new references ({\color{red}[27, 28]}) to address the concerns from another reviewer.

\rev{
3. Providing a comparison table could be useful for readers.
}

Yes, we now provide {\color{blue}Tab.~9} for better clarity on the comparison.
