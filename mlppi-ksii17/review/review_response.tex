...
OK, we now have some mentions of the above two works compared to our work. Also, we added these two in the references in the revision.
...
A great suggestion. We have relocated the related work section right after the introduction in the revised manuscript. Note also that there are some new references mentioned in the last paragraph of the related work.
...
Yes, we do now provide Tab. 9 for better clarity on the comparison.

\rev{
4. Conclusion is too long.
}

We shortened the Conclusion section. Please check page~20.
