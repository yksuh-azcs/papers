...
{\color{blue}
\tcc{{\color{green}{\scriptsize Daemon-cutoff times are derived from Steps~2 through~9.}}}
...
({\color{green}Note that different cutoff data from Tab.~\ref{tab:final_infrequent_cutoff} may be yielded on a different kernel.})
}
